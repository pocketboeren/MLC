...
house_votes_columns = ['party', 'infants', 'water', 'budget', 'physician', 'salvador', 'religious', 'satellite', 'aid',
                       ...
                       'eaa_rsa']
house_votes = pd.read_csv('W3/data/house-votes-84.csv', true_values=['y'], false_values=['n'], na_values=['?'],
...
tic_tac_toe = pd.read_csv('W3/data/tic-tac-toe.csv')
...
diabetes = pd.read_csv('W3/data/diabetes.csv')
wbc = pd.read_csv('W3/data/wbc.csv')
wbc.drop('Unnamed: 32', axis=1, inplace=True)

auto = pd.read_csv('W3/data/auto.csv')
...
liver_patients = pd.read_csv('W3/data/indian_liver_patient_preprocessed.csv')
liver_patients.drop('Unnamed: 0', axis=1, inplace=True)

liver_disease = pd.read_csv('W3/data/indian_liver_patient.csv')
